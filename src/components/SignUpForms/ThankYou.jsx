...
const accountTypeToMessage = {
  ...
  parent: `Congratulations! Your family account is now active. You can login by clicking the link below or by going to ${
    URL.split('//')[1]
  }. Once you login, you'll be able to view, register, and participate in Code Contest events!`,
  teacher:
    'Thank you for signing up with Code Contest! Your account will have limited features until it has been reviewed and approved by one of our admins. If approved, you will be able to create your own code events and have access to all of the tools needed to run your own event! You can login to your account by clicking on the link below.',
